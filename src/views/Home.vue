  ...
  <div>
    <div class="section">
      <div>
        ...
        <h1>Hello, I'm Chaeeun</h1>
        <div>
          <h2>The Limitless Designer</h2>
        </div>
        <div class="play_section">
          <div id="play" class="play_button">
            <router-link to="/About"><img src="../assets/play.svg" alt="play_button" /></router-link>
          </div>
        </div>
      </div>
    </div>
